...
const DemoApp = {
  ...
  accelerometerInit() {
    Telegram.WebApp.onEvent("accelerometerStarted", function () {
      const span =
        document.getElementById("accelerometer_btn").nextElementSibling;
      span.textContent = "";
      span.className = "";
  ...
  deviceOrientationInit() {
    ...
    Telegram.WebApp.onEvent("deviceOrientationChanged", function () {
      ...
      span.textContent =
        ...
        "; absolute: " +
        (this.DeviceOrientation.absolute ? "true" : "false") +
        ")";
      span.className = "ok";
    });
  ...
  toggleDeviceOrientation(el, need_absolute) {
    if (Telegram.WebApp.DeviceOrientation.isStarted) {
      ...
      Telegram.WebApp.DeviceOrientation.start({
        refresh_rate: 100,
        need_absolute: need_absolute,
      });
    }
  },
  updateDeviceOrientationLink() {
    var deviceOrientationBtn = document.getElementById(
      "device_orientation_btn"
    );
    ...
    if (Telegram.WebApp.DeviceOrientation.isStarted) {
      ...
      deviceOrientationBtn.innerHTML =
  ...
  locationInit(el) {
    ...
    if (!DemoApp.locationInited) {
      ...
      Telegram.WebApp.onEvent("locationManagerUpdated", function () {
        document.getElementById("loc_inited").textContent =
          locationManager.isInited ? "true" : "false";
        document.getElementById("loc_available").textContent =
          locationManager.isLocationAvailable ? "true" : "false";
        document.getElementById("loc_access_requested").textContent =
          locationManager.isAccessRequested ? "true" : "false";
        document.getElementById("loc_access_granted").textContent =
          locationManager.isAccessGranted ? "true" : "false";
        document.getElementById("loc_settings").style.display =
  ...
  homeScreenInit() {
    Telegram.WebApp.onEvent("homeScreenAdded", function (params) {
      const span =
        document.getElementById("add_to_home_btn").nextElementSibling;
  ...
  activityUpdate: function () {
    ...
    if (Telegram.WebApp.isActive) {
      ...
      curActivityElement.innerHTML =
        "Mini App is active for <b>" +
        Math.round(nowDuration / 1000) +
        "</b> sec";
    ...
    if (DemoApp.activityPrevDuration !== false) {
      ...
      prevActivityElement.innerHTML =
        ", <br>previously was active for <b>" +
        Math.round(prevDuration / 1000) +
        "</b> sec";
    }
  },
...
bgColorInput.addEventListener("change", function (e) {
  ...
  document.body.style.setProperty(
    "--bg-color",
    Telegram.WebApp.backgroundColor
  );
});
...
headerColorSel.addEventListener("change", function (e) {
  ...
  if (color === "custom") {
    ...
    document
      ...
      .classList.toggle("second", color === "secondary_bg_color");
    document.body.style.setProperty(
      "--header-color",
      Telegram.WebApp.headerColor
    );
...
document.body.style.setProperty(
  "--bottom-bar-color",
  Telegram.WebApp.bottomBarColor
);
