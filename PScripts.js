...
var printing_Color_side = document.getElementById("printing_Color_side").value;
...
var sheet_cost = (document.getElementById("sheet_cost").innerHTML = parseFloat(
  packet_price / packet_sheets
).toFixed(2));
...
var paper_cost_tdqty = (document.getElementById("paper_cost_tdqty").innerHTML =
  parseFloat(total_sheets * sheet_cost).toFixed(2));
var paper_cost_tdhlf = (document.getElementById("paper_cost_tdhlf").innerHTML =
  parseFloat(total_sheets * sheet_cost).toFixed(2));
